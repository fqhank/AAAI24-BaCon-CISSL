...
class ReMixMatch(AlgorithmBase):
    ...
    def train_step(self, x_lb, y_lb, x_ulb_w, x_ulb_s_0, x_ulb_s_1, idx_lb, idx_ulb, x_ulb_s_0_rot=None, rot_v=None):
        return x_lb, y_lb, x_ulb_w, x_ulb_s_0, x_ulb_s_1, idx_lb, idx_ulb, x_ulb_s_0_rot, rot_v
        num_lb = y_lb.shape[0]
